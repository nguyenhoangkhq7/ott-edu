          ...
          <ul className="space-y-1 px-3">
            ...
            <li>
              <button 
                ...
                onClick={() => {
                  if (assignmentButtonRef.current) {
                    setButtonRect(assignmentButtonRef.current.getBoundingClientRect());
                  }
            ...
            >
              <div className="bg-white rounded-xl shadow-2xl w-full h-[90vh] max-w-7xl pointer-events-auto" style={{ willChange: 'transform' }}>
                <CreateAssignmentForm
                  teamId={Array.isArray(params.id) ? params.id[0] : (params.id as string) || '1'}
