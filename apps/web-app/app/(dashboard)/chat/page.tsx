...
export default function ChatPage() {
  ...
  // Tránh hydration mismatch & flicker UI
  if (!mounted) {
    return <div className="h-screen w-full bg-gray-100 dark:bg-gray-900" />;
  }
  ...
  return (
    <div className="h-screen w-full bg-gray-100 dark:bg-gray-900 flex flex-col">
      ...
      <div className="bg-amber-500 text-white text-xs px-4 py-1.5 flex items-center justify-between flex-shrink-0">
        <span>
          🔧 Dev Mode — User ID:{" "}
          <code className="font-mono bg-amber-600 px-1.5 py-0.5 rounded">
            {userId}
          </code>
        </span>
        <button
