...
public class GradeService {
        ...
        public GradeResponseDTO gradeSubmission(Long submissionId, GradeRequest gradeRequest, Long teacherId) {
                ...
                return GradeResponseDTO.builder()
                                ...
                                .teamId(submission.getAssignment().getTeamId())
