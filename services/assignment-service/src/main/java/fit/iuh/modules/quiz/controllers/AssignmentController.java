...
public class AssignmentController {
        ...
        public ResponseEntity<AssignmentSummaryDto> updateAssignment(
                ...
                Long creatorId = AuthUtil.extractUserId(authentication);
                AssignmentSummaryDto updatedAssignment = assignmentService.updateAssignment(assignmentId, request,
                                creatorId);
         ...
         * STUDENT can view assignments for their team. TEACHER can view all team
         * assignments.
         */
         ...
         * Get detailed information about an assignment (STUDENT and TEACHER can view)
         */
        @PreAuthorize("hasAnyRole('STUDENT', 'TEACHER')")
